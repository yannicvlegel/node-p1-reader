    ...
    for (var i = 2; i < lines.length; i++) {
        if (lines[i] != "") {
            ...
            switch (line.obisCode) {
                ...
                case "1-0:31.7.0":
                    parsedPacket.electricity.instantaneousCurrentL1 = parseInt(line.value);
                    break;

                case "1-0:51.7.0":
                    parsedPacket.electricity.instantaneousCurrentL2 = parseInt(line.value);
                    break;

                case "1-0:71.7.0":
                    parsedPacket.electricity.instantaneousCurrentL3 = parseInt(line.value);
                    break;

                case "1-0:21.7.0":
                    parsedPacket.electricity.instantaneousActivePowerPositiveL1 = parseInt(line.value);
                    break;

                case "1-0:41.7.0":
                    parsedPacket.electricity.instantaneousActivePowerPositiveL2 = parseInt(line.value);
                    break;

                case "1-0:61.7.0":
                    parsedPacket.electricity.instantaneousActivePowerPositiveL3 = parseInt(line.value);
                    break;

                case "1-0:22.7.0":
                    parsedPacket.electricity.instantaneousActivePowerNegativeL1 = parseInt(line.value);
                    break;

                case "1-0:42.7.0":
                    parsedPacket.electricity.instantaneousActivePowerNegativeL2 = parseInt(line.value);
                    break;

                case "1-0:62.7.0":
                    parsedPacket.electricity.instantaneousActivePowerNegativeL3 = parseInt(line.value);
                    break;
