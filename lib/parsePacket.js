    ...
    for (let i = 1; i < lines.length; i++) {
        ...
        if (lines[i].replace(/(\r\n|\n|\r)/gm,"").trim() != "") {
            ...
            switch (line.obisCode) {
                ...
                // Device ID
                case "0-1:24.1.0":
                    parsedPacket.ch1.deviceType = line.value;
                    break;
                case "0-2:24.1.0":
                    parsedPacket.ch2.deviceType = line.value;
                    break;
                case "0-3:24.1.0":
                    parsedPacket.ch3.deviceType = line.value;
                    break;
                case "0-4:24.1.0":
                    parsedPacket.ch4.deviceType = line.value;
                    break;

                // Equipment ID    
                case "0-1:96.1.1":
                    parsedPacket.ch1.equipmentId = line.value;
                    break;
                case "0-2:96.1.1":
                    parsedPacket.ch2.equipmentId = line.value;
                    break;
                case "0-3:96.1.1":
                    parsedPacket.ch3.equipmentId = line.value;
                    break;
                case "0-4:96.1.1":
                    parsedPacket.ch4.equipmentId = line.value;
                    break;

                // EAN code
                case "0-1:96.1.2":
                    parsedPacket.ch1.EAN = line.value;
                    break;
                case "0-2:96.1.2":
                    parsedPacket.ch2.EAN = line.value;
                    break;
                case "0-3:96.1.2":
                    parsedPacket.ch3.EAN = line.value;
                    break;
                case "0-4:96.1.2":
                    parsedPacket.ch4.EAN = line.value;
                    break;

                // Hourly reading gas
                case "0-1:24.2.3":
                    if(parsedPacket.ch1.deviceType = "003"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch1.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch1.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch1.unit = hourlyReading.unit;
                    }
                    break;
                case "0-2:24.2.3":
                    if(parsedPacket.ch2.deviceType = "003"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch2.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch2.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch2.unit = hourlyReading.unit;
                    }
                    break;
                case "0-3:24.2.3":
                    if(parsedPacket.ch3.deviceType = "003"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch3.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch3.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch3.unit = hourlyReading.unit;
                    }
                    break;
                case "0-4:24.2.3":
                    if(parsedPacket.ch4.deviceType = "003"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch4.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch4.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch4.unit = hourlyReading.unit;
                    }
                    break;

                // Hourly readings water
                case "0-1:24.2.1":
                    if(parsedPacket.ch1.deviceType = "007"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch1.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch1.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch1.unit = hourlyReading.unit;
                    ...
                    break;
                case "0-2:24.2.1":
                    if(parsedPacket.ch2.deviceType = "007"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch2.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch2.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch2.unit = hourlyReading.unit;
                    ...
                    break;
                case "0-3:24.2.1":
                    if(parsedPacket.ch3.deviceType = "007"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch3.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch3.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch3.unit = hourlyReading.unit;
                    ...
                    break;
                case "0-4:24.2.1":
                    if(parsedPacket.ch4.deviceType = "007"){
                        hourlyReading = _parseHourlyReading(line.value);
                        parsedPacket.ch4.timestamp = _parseTimestamp(hourlyReading.timestamp);
                        parsedPacket.ch4.reading = parseFloat(hourlyReading.value);
                        parsedPacket.ch4.unit = hourlyReading.unit;
